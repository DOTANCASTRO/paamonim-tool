  ...
  return (
    <div className="flex flex-col gap-8 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <Link href="/compound-interest" className="group bg-white rounded-2xl border border-slate-200 p-7 hover:border-blue-400 hover:shadow-md transition-all flex flex-col gap-3">
          ...
          <span className="text-blue-600 text-sm font-medium mt-1">התחל →</span>
        </Link>

        <Link href="/event-planner" className="group bg-white rounded-2xl border border-slate-200 p-7 hover:border-blue-400 hover:shadow-md transition-all flex flex-col gap-3">
          <div className="text-4xl">🎯</div>
          <h2 className="text-xl font-bold text-slate-800 group-hover:text-blue-700 transition-colors">
